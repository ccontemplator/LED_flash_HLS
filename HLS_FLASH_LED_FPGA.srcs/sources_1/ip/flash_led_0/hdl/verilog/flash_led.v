...
(* CORE_GENERATION_INFO="flash_led,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg400-2,HLS_INPUT_CLOCK=20.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.967750,HLS_SYN_LAT=100000001,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=32,HLS_SYN_LUT=70,HLS_VERSION=2019_2}" *)
...
reg   [0:0] r_V_reg_86;
reg    ap_block_state1;
wire   [26:0] i_fu_74_p2;
wire    ap_CS_fsm_state2;
reg   [26:0] i_0_reg_51;
wire   [0:0] icmp_ln7_fu_68_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((icmp_ln7_fu_68_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            led_i_V_ap_vld_preg <= 1'b0;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln7_fu_68_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        i_0_reg_51 <= i_fu_74_p2;
...
always @ (*) begin
    if (((icmp_ln8_fu_80_p2 == 1'd1) & (icmp_ln7_fu_68_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        led_o_V_ap_vld = 1'b1;
    end else begin
        led_o_V_ap_vld = 1'b0;
    end
...
assign i_fu_74_p2 = (i_0_reg_51 + 27'd1);

assign icmp_ln7_fu_68_p2 = ((i_0_reg_51 == 27'd100000000) ? 1'b1 : 1'b0);

assign icmp_ln8_fu_80_p2 = ((i_0_reg_51 == 27'd99999998) ? 1'b1 : 1'b0);
